...
PARAM$finalmodel$num_iterations    <-  977
PARAM$finalmodel$learning_rate     <-    0.0102085970626968
PARAM$finalmodel$feature_fraction  <-    0.601703166989346
PARAM$finalmodel$min_data_in_leaf  <-    1407
PARAM$finalmodel$num_leaves        <-     385
