      ...
      for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
        for (vmin_bucket in c(1000, 800, 600, 400, 200, 100, 50, 20, 10, 2, vmin_split / 4)) { # nolint: line_length_linter.
          ...
          param_basicos <- list(
            ...
            "minsplit" = vmin_split, # minima cantidad de registros en un nodo para hacer el split # nolint: line_length_linter.
            "minbucket" = vmin_bucket) # minima cantidad de registros en una hoja # nolint
